...
function DetailsScreen() {
 ...
 const details = [{label :"Мы очень любим ваших детей!Однако хотим предупредить, что наше торжество будет исключительно для взрослых. Заранее благодарим за понимание и с нетерпением ждем встречи с вами!"},
                ...
                {label :"Наша свадьба начинается с торжественной росписи в ЗАГСе Первомайского района. После этого мы будем рады встретить вас на банкете. Мы беспокоимся о вашем удобстве, и предлагаем вам самим выбрать с какой локации начнется торжество."}]
  return (
